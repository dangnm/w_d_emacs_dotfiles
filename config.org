...
(cond
 ...
 ((string-equal system-type "darwin") ;  macOS
  (progn
    (message "Mac OS X")
    (setq doom-font (font-spec :family "Source Code Pro-16" :size 24)
          doom-big-font (font-spec :family "Source Code Pro-16" :size 36)
          doom-variable-pitch-font (font-spec :family "Source Code Pro-16" :size 24)
          doom-unicode-font (font-spec :family "Source Code Pro-16")
          doom-serif-font (font-spec :family "Source Code Pro-16" :weight 'light))
    ))
